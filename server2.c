...
{
	int i, port, listenfd, socketfd, thread_pool_size;//listenfd is file descriptor to listening socket. 
	...
	printf("HI THIS THE THE THREADPOOL SIZE: %d\n", thread_pool_size);
	...
	/*DETACH/JOIN?for(i = 0; i < thread_pool_size;i++){
